...
/// Custom painter para crear rayas diagonales alternadas
/// Usado en las barras de progreso
class DiagonalStripesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final totalStripes = (size.width / stripeWidth).ceil() + 
                        (size.height / stripeWidth).ceil() + 2;
